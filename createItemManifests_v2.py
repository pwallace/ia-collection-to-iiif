...
# infile expects the filename of a CSV containing two columns 1) Internet Archive identifiers and 2) item title/label
...
manifestdata["label"] = "IIIF Collection for the " + collectionlabel + " collection at Internet Archive"
